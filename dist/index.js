...
// node_modules/depcheck/node_modules/ignore/index.js
var require_ignore = __commonJS({
  "node_modules/depcheck/node_modules/ignore/index.js"(exports2, module2) {
  ...
  "node_modules/readdirp/index.js"(exports2, module2) {
    ...
    var readdirpPromise = (root, options = {}) => {
      return new Promise((resolve, reject) => {
        const files = [];
        readdirp(root, options).on("data", (entry) => files.push(entry)).on("end", () => resolve(files)).on("error", (error2) => reject(error2));
      });
    };
...
// node_modules/require-package-name/index.js
var require_require_package_name = __commonJS({
  "node_modules/require-package-name/index.js"(exports2, module2) {
    var scopePattern = /^(?:(@[^/]+)[/]+)([^/]+)[/]?/;
    var basePattern = /^([^/]+)[/]?/;
    module2.exports = extract.bind(null, false);
    module2.exports.base = extract.bind(null, true);
...
// node_modules/depcheck/dist/utils/file.js
var require_file = __commonJS({
  "node_modules/depcheck/dist/utils/file.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    exports2.getContent = getContent;
    exports2.setContent = setContent;
...
// node_modules/depcheck/dist/utils/get-scripts.js
var require_get_scripts = __commonJS({
  "node_modules/depcheck/dist/utils/get-scripts.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    exports2.clearCache = clearCache;
    exports2.default = getScripts;
...
// node_modules/depcheck/dist/utils/index.js
var require_utils3 = __commonJS({
  "node_modules/depcheck/dist/utils/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    ...
    exports2.loadModuleData = loadModuleData;
    exports2.tryRequire = tryRequire;
    exports2.wrapToArray = wrapToArray;
    exports2.wrapToMap = wrapToMap;
    Object.defineProperty(exports2, "getScripts", {
      enumerable: true,
      get: function() {
    ...
    var _getScripts = _interopRequireDefault(require_get_scripts());
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    ...
    function tryRequire(module3, paths = []) {
      try {
...
// node_modules/depcheck/dist/utils/parser.js
var require_parser = __commonJS({
  "node_modules/depcheck/dist/utils/parser.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    exports2.default = getNodes;
    var _lodash = _interopRequireDefault(require_lodash());
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
...
// node_modules/depcheck/dist/utils/typescript.js
var require_typescript = __commonJS({
  "node_modules/depcheck/dist/utils/typescript.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    exports2.getAtTypesName = getAtTypesName;
    var _isCoreModule = _interopRequireDefault(require_is_core_module());
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    var orgDepRegex = /@(.*?)\/(.*)/;
...
// node_modules/depcheck/dist/component.json
var require_component = __commonJS({
  "node_modules/depcheck/dist/component.json"(exports2, module2) {
    module2.exports = {
      parser: [
        "coffee",
        "es6",
...
// node_modules/depcheck/dist/constants.js
var require_constants2 = __commonJS({
  "node_modules/depcheck/dist/constants.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    exports2.defaultOptions = exports2.availableSpecials = exports2.availableDetectors = exports2.availableParsers = void 0;
    var _path = _interopRequireDefault(require("path"));
    var _lodash = _interopRequireDefault(require_lodash());
    ...
    function constructComponent(source, name) {
      return (0, _lodash.default)(source[name]).map((file) => [
        file,
        require(_path.default.resolve(__dirname, name, file))
      ]).fromPairs().value();
    }
    var availableParsers = constructComponent(_component.default, "parser");
    exports2.availableParsers = availableParsers;
    var availableDetectors = constructComponent(_component.default, "detector");
    exports2.availableDetectors = availableDetectors;
    var availableSpecials = constructComponent(_component.default, "special");
    exports2.availableSpecials = availableSpecials;
    var defaultOptions = {
...
// node_modules/depcheck/dist/check.js
var require_check = __commonJS({
  "node_modules/depcheck/dist/check.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    exports2.default = check;
    var _path = _interopRequireDefault(require("path"));
    var _debug = _interopRequireDefault(require_src());
    var _isCoreModule = _interopRequireDefault(require_is_core_module());
    var _lodash = _interopRequireDefault(require_lodash());
    var _readdirp = _interopRequireDefault(require_readdirp());
    var _minimatch = _interopRequireDefault(require_minimatch());
    var _requirePackageName = _interopRequireDefault(require_require_package_name());
    ...
    async function getDependencies(dir, filename, deps, parser, detectors) {
      ...
      return (0, _lodash.default)(dependencies).concat(peerDeps).concat(optionalDeps).filter((dep) => dep && dep !== "." && dep !== "..").filter((dep) => !(0, _isCoreModule.default)(dep)).uniq().value();
    }
    function checkFile(dir, filename, deps, parsers, detectors) {
      (0, _debug.default)("depcheck:checkFile")(filename);
      const targets = (0, _lodash.default)(parsers).keys().filter((glob2) => (0, _minimatch.default)(filename, glob2, {
        dot: true
      ...
      return targets.map((parser) => getDependencies(dir, filename, deps, parser, detectors).then((using) => {
        ...
        (0, _debug.default)("depcheck:checkFile:error")(filename, parser, error2);
        return {
          invalidFiles: {
            [filename]: error2
          }
    ...
    function checkDirectory(dir, rootDir, ignorer, deps, parsers, detectors) {
      ...
      return new Promise((resolve) => {
        ...
        finder.on("warn", (error2) => {
          (0, _debug.default)("depcheck:checkDirectory:error")(dir, error2);
    ...
    function buildResult(result, deps, devDeps, peerDeps, optionalDeps, skipMissing) {
      const usingDepsLookup = (0, _lodash.default)(result.using).toPairs().map(([file, dep]) => [dep, _lodash.default.times(dep.length, () => file)]).map((pairs) => _lodash.default.zip(...pairs)).flatten().groupBy(([dep]) => dep).mapValues((pairs) => pairs.map(_lodash.default.last)).value();
...
// node_modules/depcheck/dist/index.js
var require_dist = __commonJS({
  "node_modules/depcheck/dist/index.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    exports2.default = depcheck2;
    var _fs = _interopRequireDefault(require("fs"));
    var _path = _interopRequireDefault(require("path"));
    var _lodash = _interopRequireDefault(require_lodash());
    var _multimatch = _interopRequireDefault(require_multimatch());
    var _ignore = _interopRequireDefault(require_ignore());
    var _debug = _interopRequireDefault(require_src());
    ...
    function registerTs(rootDir) {
      if (!require.extensions[".ts"]) {
        ...
        if (ts) {
          require.extensions[".ts"] = (module3, filename) => {
            ...
            const transpiled = ts.transpileModule(content.charCodeAt(0) === 65279 ? content.slice(1) : content, options);
            module3._compile(transpiled.outputText, filename);
          };
        }
      }
    }
    ...
    function depcheck2(rootDir, options, callback) {
      registerTs(rootDir);
    ...
    depcheck2.parser = _constants.availableParsers;
    depcheck2.detector = _constants.availableDetectors;
    depcheck2.special = _constants.availableSpecials;
    module2.exports = exports2.default;
  }
});
...
async function depCheck(path2) {
  ...
  core.info(`Checking package: "${path2}"`);
  const res = await (0, import_depcheck.default)(path2, {});
